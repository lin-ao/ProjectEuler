...
def parse_list(input_list: str) -> list[list[int]]:
    matrix = [[int(col) for col in row.split(" ") if col] for row in input_list.split("                  ")]
    return matrix
...
def main() -> None:
    input_list = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08 \
